...
void zip_dpu(__mram_ptr void *table_entries_1, __mram_ptr void *table_entries_2,
  ...
  uint32_t types_div_4 =
      (input_type_1_rest_4 == 0) && (input_type_2_rest_4 == 0);
  uint32_t types_are_ints =
      (input_type_1_div_4 == 1) && (input_type_2_div_4 == 1);
    ...
    if (types_are_ints) {
      ...
      for (int i = pid_times_block_size; i < divisible_len;
        ...
        mram_read((__mram_ptr void *)table_entries_2 + i_input2, input2_block,
                  input_block_size_2);
        mram_read((__mram_ptr void *)table_entries_res + i_output, output_block,
                  output_block_size);
        ...
        mram_write(output_block, table_entries_res + i_output,
                   output_block_size);
