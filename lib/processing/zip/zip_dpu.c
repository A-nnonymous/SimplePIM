...
int main() {
  ...
  zip_dpu(DPU_MRAM_HEAP_POINTER + input_start_offset1,
          DPU_MRAM_HEAP_POINTER + input_start_offset2,
          DPU_MRAM_HEAP_POINTER + outputs, input_type_size1, input_type_size2,
          len);
  return 0;
}